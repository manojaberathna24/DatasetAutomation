...
"""
                            ...
                            result['answer'] = followup_response.text.strip()
                    except Exception as e:
                        result['error'] = str(e)
...
"""
    ...
    def _fallback_query(self, df, question):
        ...
        return {
            "answer": "AI chat is not configured. Please set GEMINI_API_KEY in your .env file.",
            "code": None,
            "chart_type": "none"
        }
    ...
    def _fallback_insights(self, df):
        ...
        insights = {
            "key_insights": [
                ...
                "Configure GEMINI_API_KEY in .env for detailed analysis"
            ],
            "recommendations": [
                "Set up Gemini API key for AI-powered insights",
