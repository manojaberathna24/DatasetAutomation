...
<div class="terminal-header">
    <h1>{emojis['wrench']} DATA SANITIZATION TERMINAL {emojis['wrench']}</h1>
    <p>{emojis['fire']} Advanced Data Cleaning & Optimization System</p>
</div>
...
if not st.session_state.current_dataset:
    ...
    <div class="terminal-block" style="border-color: #ff0000;">
        ...
        <p style="color: #00ffff;">Upload a dataset first to initialize cleaning terminal</p>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
