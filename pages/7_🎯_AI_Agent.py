...
<div class="terminal-header">
    <h1>{emojis['brain']} AUTONOMOUS AI AGENT {emojis['brain']}</h1>
    <p>{emojis['fire']} Intelligent Business Analytics & Insight Generation System</p>
</div>
...
if not st.session_state.current_dataset:
    ...
    <div class="terminal-block" style="border-color: #ff0000;">
        ...
        <p style="color: #00ffff;">Upload a dataset first to activate AI agent</p>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
