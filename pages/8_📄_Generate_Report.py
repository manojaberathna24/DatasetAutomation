...
<div class="terminal-header">
    <h1>{emojis['data']} REPORT GENERATION TERMINAL {emojis['data']}</h1>
    <p>{emojis['fire']} Professional PDF Report Compilation System</p>
</div>
...
if not st.session_state.current_dataset:
    ...
    <div class="terminal-block" style="border-color: #ff0000;">
        ...
        <p style="color: #00ffff;">Upload a dataset first to generate reports</p>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
