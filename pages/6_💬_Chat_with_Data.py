...
<div class="terminal-header">
    <h1>{emojis['computer']} AI CHAT INTERFACE {emojis['computer']}</h1>
    <p>{emojis['brain']} Natural Language Data Query System</p>
</div>
...
if not st.session_state.current_dataset:
    ...
    <div class="terminal-block" style="border-color: #ff0000;">
        ...
        <p style="color: #00ffff;">Upload a dataset first to initialize chat interface</p>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
...
# Data preview
with st.expander("👁️ Quick Data Preview"):
